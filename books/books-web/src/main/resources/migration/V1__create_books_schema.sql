...
INSERT INTO book (title, author, difficulty_id) VALUES
    ('The Hobbit', 'John Ronald Reuel Tolkien', 'E'),
    ('The Lord of the Rings', 'John Ronald Reuel Tolkien', 'M'),
    ('The Name of the Wind', 'Patrick Rothfuss', 'H');
